...
const Footer = ({ namespace }: FooterProps) => {
    ...
    <Section className="pb-16 pt-0">
      <CenteredFooter
        ...
        legalLinks={
          <>
            <li>
              <Link href="/">{t('Footer.terms_of_service')}</Link>
            </li>
            <li>
              <Link href="/">{t('Footer.privacy_policy')}</Link>
            </li>
          </>
        }
      >
        <li>
          <Link href="/">{t('Footer.product')}</Link>
        </li>

        <li>
          <Link href="/">{t('Footer.docs')}</Link>
        </li>
        ...
        <li>
          <Link href="/">{t('Footer.company')}</Link>
        </li>
      </CenteredFooter>
    </Section>
  );
